...
- **Semi-opaque text blends toward brand paper** (`_blend_to_paper`): run alpha is approximated by blending toward the brand's `paper` token colour instead of white — dark-brand decks no longer get inverted-contrast ghost text.

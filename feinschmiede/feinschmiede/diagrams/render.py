...
New code should prefer :func:`feinschmiede.diagrams.renderer.choose_renderer` which
exposes the same dispatch logic as a clean :class:`~feinschmiede.diagrams.renderer.Renderer`
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m feinschmiede.diagrams.render")

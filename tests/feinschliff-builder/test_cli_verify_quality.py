...
_TESTS_FEINSCHLIFF = _BUILDER_ROOT.parent / "tests" / "feinschliff"
SAMPLE_DECK = _TESTS_FEINSCHLIFF / "fixtures" / "verify_quality" / "clean-deck.pptx"
...
def _ensure_fixture(tmp_path):
    if not SAMPLE_DECK.exists():
        ...
        subprocess.check_call([
            ...
            "--brand", "feinschliff",
            "--content", str(_TESTS_FEINSCHLIFF / "fixtures" / "verify_quality" / "executive-summary-content.yaml"),
            "-o", str(SAMPLE_DECK),
        ], cwd=REPO_ROOT)

...
def _brand_dir() -> Path:
    _feinbild = Path(__file__).resolve().parent.parent.parent / "feinbild"
    return _feinbild / "src" / "feinbild" / "brands" / "feinschliff"


SKILLS_DIR = Path(__file__).resolve().parent.parent.parent / "feinbild" / "skills"

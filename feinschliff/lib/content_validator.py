...
if TYPE_CHECKING:
    from lib.slot_budget import SlotBudget
...
def _check_slot_overflow(
    ...
    *,
    ...
    from lib.textfit import fits as _fits  # local import — no hard dep at module level
    ...
    from lib.textfit import measure_height_emu as _measure
    actual_h = _measure(
        value,
        font=budget.font_family,
        size_pt=budget.size_pt,

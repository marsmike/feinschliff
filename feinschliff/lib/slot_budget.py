...
from lib.dsl.parser import DSLNode, CompoundDef
from lib.dsl.tokens import Tokens
from lib.textfit import chars_per_line as _cpl, supported_fonts as _supported_fonts
...
def compute_slot_budgets(
    ...
    *,
    ...
    if compounds:
        ...
        from lib.dsl.expander import expand_compounds  # local import; avoid cycle

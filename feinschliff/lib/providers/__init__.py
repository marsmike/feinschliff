...
into :data:`lib.image_provider._REGISTRY`. Discovery only needs to
...
:func:`lib.image_provider.discover_providers` via the normal file-scan
mechanism.
"""
from __future__ import annotations

from lib.providers import unsplash  # noqa: F401 — side-effect import

...
class RoughRenderer:
    ...
    def render_png(self, src: Path, out: Path) -> Path:
        from lib.diagrams.render_rough import render_excalidraw
...
class PlaywrightRenderer:
    ...
    def render_png(self, src: Path, out: Path) -> Path:
        ...
        if ext == ".excalidraw":
            from lib.diagrams.render_playwright import render_excalidraw
            return render_excalidraw(src, out)
        # .svg path: inline SVG → Playwright screenshot
        from lib.diagrams.render import _render_svg_playwright

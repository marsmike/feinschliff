...
def test_offline_returns_pass():
    from feinschliff.verify.deck.ghost_deck import judge_ghost_deck
...
def test_judge_invokes_judge_helper():
    from feinschliff.verify.deck import ghost_deck as gd_mod
...
def test_write_report_includes_titles_and_issues(tmp_path: Path):
    from feinschliff.verify.deck.ghost_deck import GhostDeckResult, write_ghost_deck_report

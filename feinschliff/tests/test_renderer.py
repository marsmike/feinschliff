...
from lib.diagrams.renderer import (
    PlaywrightRenderer,
    Renderer,
    RoughRenderer,
    _REGISTRY,
...
@patch("lib.diagrams.renderer.RoughRenderer._available", return_value=True)
...
@patch("lib.diagrams.renderer.RoughRenderer._available", return_value=False)
...
def test_choose_renderer_raises_when_no_support(tmp_path):
    ...
    import lib.diagrams.renderer as _mod

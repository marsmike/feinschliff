...
from lib.layout_discovery import (
    LayoutSource,
    Layout,
    discover_layouts,
    find_layout,
...
def test_find_layout_returns_none_no_sources(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("FEINSCHLIFF_LAYOUT_PATH", "")
    monkeypatch.setattr("lib.layout_discovery._bundled_layouts_root", lambda: tmp_path / "no-bundled")
    monkeypatch.setattr("lib.layout_discovery._user_layouts_root", lambda: tmp_path / "no-user")
    monkeypatch.setattr("lib.layout_discovery._plugin_layouts_roots", lambda: [])
    monkeypatch.setattr("lib.layout_discovery._cwd_dev_layouts_roots", lambda: [])

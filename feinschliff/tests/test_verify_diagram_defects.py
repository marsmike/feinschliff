...
def test_diagram_overflow_caught():
    from lib.layout_validator import validate_diagrams
    pic = _FakePic(
        kw_args={
...
def test_diagram_color_mismatch_caught(tmp_path):
    from lib.layout_validator import validate_diagrams_color
...
def test_diagram_text_too_small_caught():
    from lib.layout_validator import validate_diagrams_text_size
    pic = _FakePic(
        kw_args={
